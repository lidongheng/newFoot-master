...
class ReportGenerator:
    ...
    def generate_sentiment_report(
        ...
        charts_html.append(f'<div class="chart-card"><div class="chart-title">📊 情感综合评分</div>{fig1.to_html(full_html=False, include_plotlyjs=False, config={"responsive": True})}</div>')
    ...
    def generate_backtest_report(
        ...
        charts_html.append(
            ...
            f'{fig_comp.to_html(full_html=False, include_plotlyjs=False, config={"responsive": True})}</div>'
        )
    ...
    def generate_single_backtest_report(
        ...
        if eq:
            ...
            charts_html.append(
                ...
                f'{fig_eq.to_html(full_html=False, include_plotlyjs=False, config={"responsive": True})}</div>'
            )
    ...
    def generate_comparison_report(
        ...
        charts_html.append(
            ...
            f'{fig1.to_html(full_html=False, include_plotlyjs=False, config={"responsive": True})}'
            '</div>'
        )
