// Fix for undici File is not defined error in Node.js v18
require('./fix-undici')
...
let rounds = fs.readFileSync(`./match_center/${staticData.leagueSerial}.js`, 'utf8')
var jh = []
eval(rounds)
...
const matchArr = []
let team = {}
const players = JSON.parse(fs.readFileSync(`./player_center/${global.serial}.json`, 'utf8'))
// 是否国家队分析
...
setTimeout(() => {
  ...
  fs.writeFileSync(`./player_center/${global.serial}.json`, JSON.stringify(newPlayers), 'utf8')
}, 4000)