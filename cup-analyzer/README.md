...
│   ├── rule/                          # 联赛规则（升降级、欧战资格）
│   ├── data/                          # c36.js、l36.js、bs36.js、td36.js 等
...
# 英超 → 写入 epl/data/c36.js（赛季目录 2025-2026，见 config）
...
- **阶段一（赛前）**：维护 data（c36/l36/bs36/td36）、冠军赔率、球队序号；**Big 6** `teamProfile/`（含转会窗、圣诞新年赛程）
